...
const placeholder: Department = {
    ...
    ['Техническое']: {
        ...
        items: [
            ...
            {
                title: 'Система автоматизированного проектирования – программа «Автокад',
                describe: 'Системы и AutoCAD предназначены для создания чертежей и трехмерных моделей отдельных деталей, и сборочных единиц, содержащих как оригинальные, так и стандартизованные конструктивные элементы. Параметрическая технология позволяет быстро получать модели типовых изделий на основе однажды спроектированного прототипа. Многочисленные сервисные функции облегчают решение вспомогательных задач проектирования и обслуживания производства. ',
                image: 'img/5.jpg',
                price: 3770,
                hours: {
                    regular: 10,
